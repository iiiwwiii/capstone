...
<div class="alert alert-info" role="alert" style="margin-top:20px;"> 등록된 유치원 일정이 없습니다. </div>
...
<h3 class="ui center aligned header" style="margin-top:3%;">일정 수 : <%=monthcount %></h3>
<br>
		...
		<tbody>				
			<%
				for (int i = 0 ; i < calendarMonthList.size(); i++) {				
					TeacherCalendarVO notice = calendarMonthList.get(i);	
			%>				
			<tr>
